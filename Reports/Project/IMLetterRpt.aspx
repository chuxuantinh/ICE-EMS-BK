<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/FO/FORptMaster.master" AutoEventWireup="true" CodeFile="IMLetterRpt.aspx.cs" Inherits="Reports_project_IMLeteerRpt" %>
...
<div id="dates" runat="server" style="text-align:center;">Sesssion:<asp:DropDownList ID="ddlExamSeason" runat="server" AutoPostBack="true" 
    ...
    &nbsp;&nbsp;IMID:<asp:TextBox ID="txtIMID" runat="server" AutoPostBack="true" 
  ...
  <CR:CrystalReportViewer ID="IM_Letter_Report" 
       ...
       HasCrystalLogo="False" HasToggleGroupTreeButton="false" 
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="IMLetterCrt.rpt">
            </Report>
