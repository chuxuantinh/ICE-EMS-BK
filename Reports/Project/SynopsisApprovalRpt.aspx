...
<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">Synopsis Approval Report
</asp:Content>
...
<asp:RadioButtonList ID="rbtnlstSelect" runat="server" 
        ...
        onselectedindexchanged="rbtnlstSelect_SelectedIndexChanged" ><asp:ListItem Text="Date" Value="Date" Selected="True"></asp:ListItem><asp:ListItem Value="Session" Text="Session" /></asp:RadioButtonList><br />
...
Session:<asp:DropDownList ID="ddlSession" runat="server" CssClass="txtbox">
   ...
   &nbsp;&nbsp;
    Status:<asp:DropDownList ID="ddlStatus" CssClass="txtbox" runat="server" Width="150px">
            <asp:ListItem>ProformaBSubmitted</asp:ListItem>
            <asp:ListItem>ProformaBApproved</asp:ListItem>
             </asp:DropDownList>
...
Synopsis Date:<asp:TextBox Width="100px" ID="txtDate1" runat="server" CssClass="txtbox"></asp:TextBox>
...
<dev:CalendarExtender Format="dd/MM/yyyy" ID="CalendarExtender1" PopupButtonID="cald" PopupPosition="BottomRight" runat="server" TargetControlID="txtDate2"></dev:CalendarExtender><img src="../../images/cal.png" id="cald" runat="server"  alt="Cald" />
         ...
         &nbsp;&nbsp;
          ...
          Entry Status:<asp:DropDownList ID="ddlEntryStatus" CssClass="txtbox" runat="server" Width="150px">
          <asp:ListItem>Running</asp:ListItem>
           <asp:ListItem>OldProject</asp:ListItem>
  ...
  <div style="width:100%">
  <CR:CrystalReportViewer ID="Project_Synopsis_Report" runat="server" Width="100%" 
       ...
       HasCrystalLogo="False" HasToggleGroupTreeButton="false" 
        BorderStyle="None" AutoDataBind="True" Height="1039px" 
