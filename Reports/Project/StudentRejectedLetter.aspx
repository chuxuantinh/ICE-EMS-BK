<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/FO/FORptMaster.master" AutoEventWireup="true" CodeFile="StudentRejectedLetter.aspx.cs" Inherits="Reports_Project_StudentRejectedLetter" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="dev" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.2000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304"
    Namespace="CrystalDecisions.Web" TagPrefix="CR" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">Project Rejected Letter to Students
</asp:Content>
...
<div align="center">
<h2>Project Rejected Letter to Students</h2>
<br />
...
<CR:CrystalReportViewer ID="StuRejectedLetter_Report" 
       ...
       HasCrystalLogo="False" HasToggleGroupTreeButton="false" 
        ...
        oninit="StuRejectedLetter_Report_Init"/>
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="StudentRejectedLetter.rpt">
            </Report>
