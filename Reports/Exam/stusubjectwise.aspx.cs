...
public partial class Reports_Exam_stusubjectwise : System.Web.UI.Page
{
    ...
    public DataTable getdata()
    {
        ...
        {
            con.Open();
            cmd.CommandText = "select ExamForm.SubID , count(ExamForm.SID) as EFSIDCount from Examform inner join Examforms on ExamForm.SN = ExamForms.SN where ExamForms.ExamSeason='" + ddlSession.SelectedValue.ToString() + txtYear.Text + "' group by (ExamForm.SubID)";
            cmd.Connection = con;
            ds = new DataSet();
    ...
    public void LoadReport(ReportState rptState)
    {
        if (rptState != ReportState.FromPostBack)
        {
            try
            {
                ...
                rptdoc.Load(Server.MapPath("stusubjectwiseCrt.rpt"));
