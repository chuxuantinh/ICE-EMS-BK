<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Exam/Exam.master" AutoEventWireup="true" CodeFile="AdmitCardDuplicate.aspx.cs" Inherits="Reports_Exam_AdmitCardDuplicate" %>
...
<CR:CrystalReportViewer ID="AdmitCDup" runat="server" 
       ...
       HasCrystalLogo="False" HasToggleGroupTreeButton="false" BorderStyle="None" />
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="AdmitCa.rpt"></Report>
