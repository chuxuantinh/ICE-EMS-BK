<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Exam/Exam.master" AutoEventWireup="true" CodeFile="CenterDateSessionwise.aspx.cs" Inherits="Reports_Exam_CenterDateSessionwise" %>
...
<asp:ScriptManager ID="Scriptmanager1" runat="server" ></asp:ScriptManager>
  <div id="reporttitle"><b>Number of Candidate appearing Exam City, Date and Session Wise</b></div>
    <div align="center">
  <br />
   ...
   <cr:crystalreportviewer ID="subwiseReport" 
    ...
    ToolPanelView="None" HasCrystalLogo="False" HasToggleGroupTreeButton="false" 
        ...
        <cr:crystalreportsource ID="CrystalReportSource1" runat="server">
            <Report FileName="CenterDateSessionwiseCrt.rpt">
            </Report>
