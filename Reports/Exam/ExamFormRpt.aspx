<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Exam/Exam.master" AutoEventWireup="true" CodeFile="ExamFormRpt.aspx.cs" Inherits="Reports_Exam_ExamFormRpt" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="dev" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.2000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304"
    Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">ExamForm
</asp:Content>
...
<asp:ScriptManager ID="Scriptmanager1" runat="server" ></asp:ScriptManager>
   <div id="reporttitle"><b>Exam Form Report: </b> Details of Submitted Exam Form in Examination Section. Report contain whole data of submitted subjects in perticular session</div>
...
<table><tr><td>&nbsp;&nbsp; Session
    ...
    <td>&nbsp;&nbsp; Year
        <asp:TextBox ID="txtYear" runat="server" CssClass="txtbox" Width="95px"></asp:TextBox>
          ...
          <tr> <asp:Panel ID="panDepartmentName" runat="server"><td colspan="4" align="center">Department
              ...
              <tr><td colspan="3" align="center"><asp:Label ID="lblImid" runat="server" Text="IMID:"> </asp:Label>
   ...
   <cr:crystalreportviewer ID="ExamForm" 
    ...
    ToolPanelView="None" HasCrystalLogo="False" HasToggleGroupTreeButton="false" 
        ...
        <cr:crystalreportsource ID="CrystalReportSource1" runat="server">
            <Report FileName="ExamFormCrt.rpt">
            </Report>
