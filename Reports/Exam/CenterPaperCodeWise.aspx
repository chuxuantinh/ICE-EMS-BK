<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Exam/Exam.master" AutoEventWireup="true" CodeFile="CenterPaperCodeWise.aspx.cs" Inherits="Reports_Exam_CenterPaperCodeWise" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2> Number of Candidate appearing in the Examination date, session and paper code wise</h2>
<div align="center">
...
<%--  <div style="width:100%">--%>
  <CR:CrystalReportViewer ID="CenterPaperCodewise" 
       ...
       HasCrystalLogo="False" HasToggleGroupTreeButton="false" 
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="CenterPaperCodewiseCrt.rpt">
            </Report>
