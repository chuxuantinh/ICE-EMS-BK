<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Exam/Exam.master" AutoEventWireup="true" CodeFile="AttendanceSheetRpt.aspx.cs" Inherits="Reports_Exam_AttendanceSheetRpt" %>
...
<div id="reporttitle"><b>Attendance Sheet Report:</b></div>
...
<asp:Button ID="btnView" runat="server" CssClass="btnsmall" OnClick="btnVeiw_OnClick" Text="View" />
 <br />
    Center Code:<asp:TextBox ID="txtSID" runat="server" CssClass="txtbox" Width="95px"></asp:TextBox>
...
<CR:CrystalReportViewer ID="AttendanceSheet" runat="server" 
       ...
       HasCrystalLogo="False" HasToggleGroupTreeButton="false" BorderStyle="None" />
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="AttendanceSheetCrt.rpt"></Report>
