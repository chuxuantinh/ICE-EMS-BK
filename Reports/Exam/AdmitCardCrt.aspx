<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Exam/Exam.master" AutoEventWireup="true" CodeFile="AdmitCardCrt.aspx.cs" Inherits="Reports_Exam_AdmitCardCrt" %>
...
<CR:CrystalReportViewer ID="AdmitCard" runat="server" 
       ...
       HasCrystalLogo="False" HasToggleGroupTreeButton="false" BorderStyle="None" />
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="AdmitCards.rpt"></Report>
