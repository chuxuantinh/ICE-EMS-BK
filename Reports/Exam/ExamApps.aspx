<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Exam/Exam.master" AutoEventWireup="true" CodeFile="ExamApps.aspx.cs" Inherits="Reports_Exam_ExamApps" %>
...
<asp:ScriptManager ID="Scriptmanager1" runat="server" ></asp:ScriptManager>
  <div id="reporttitle"><b>Admission Form Report: </b>Details of Admission Form with Serial No in selected Session.</div>
    <div align="center">
  <br />
...
<table><tr><td>&nbsp;&nbsp; Session
   ...
   <cr:crystalreportviewer ID="AdmissionView" 
    ...
    ToolPanelView="None" HasCrystalLogo="False" HasToggleGroupTreeButton="false" 
        ...
        <cr:crystalreportsource ID="CrystalReportSource1" runat="server">
            <Report FileName="ExamAdmissionCrt.rpt">
            </Report>
