<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Exam/Exam.master" AutoEventWireup="true" CodeFile="BookletRangeICE.aspx.cs" Inherits="Reports_Exam_BookletRangeICE" %>


<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="dev" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.2000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304"
    Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content ID="Content4" ContentPlaceHolderID="title" Runat="Server">Booklet Range ICE(I)
</asp:Content>
...
Session:<asp:DropDownList ID="ddlSession" runat="server" CssClass="txtbox">
    ...
    Exam Type:&nbsp;&nbsp;<asp:DropDownList runat="server" ID="ddlType" ><asp:ListItem Value="Home" Text="Home"></asp:ListItem><asp:ListItem Value="Overseas" Text="Overseas"></asp:ListItem></asp:DropDownList> 
    &nbsp;&nbsp;&nbsp;   <asp:Button ID="btnView" runat="server" Text="View" CssClass="btnsmall" onclick="btnView_Click" /><br />
                    </div>
<%--  <div style="width:100%">--%>
  <CR:CrystalReportViewer ID="Booklet_Range_ICE" 
       ...
       HasCrystalLogo="False" HasToggleGroupTreeButton="false" 
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="BookletRangeICECrt.rpt">
            </Report>
