...
public partial class Reports_AC_AccountReportMaster : System.Web.UI.MasterPage
{
    ...
    {
        Response.Redirect("Default.aspx?maikal=" + Request.QueryString["maikal"] + "&lnk=rpt&lvl=zero&typ=AC");
    }
}