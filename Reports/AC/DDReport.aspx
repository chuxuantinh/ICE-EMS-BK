<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/AC/AccountReportMaster.master" AutoEventWireup="true" CodeFile="DDReport.aspx.cs" Inherits="Reports_AC_DDReport" %>
...
<ContentTemplate>
<center><asp:RadioButton ID="rbtnDate" runat="server" Text="Date" Visible="false" AutoPostBack="true" GroupName="A"  />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:RadioButton ID="rbtnDiaryNo" runat="server" Text="Diary No" AutoPostBack="true" GroupName="A" Visible="false" /></center>
...
<asp:Label ID="lblExceptioN" runat="server" Font-Bold="true"></asp:Label><hr />
 ...
 <CR:CrystalReportViewer ID="DD_Entry_Reports" runat="server" Width="100%" 
