<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/FO/FORptMaster.master" AutoEventWireup="true" CodeFile="IMStockRpt.aspx.cs" Inherits="Reports_Invent_IMStockRpt" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="dev" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.2000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304"
    Namespace="CrystalDecisions.Web" TagPrefix="CR" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">IM Stock Detail Report
</asp:Content>
...
<div align="center">
<h2>Required IM Stock Detail</h2>
<table class="tbl">
<tr><td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<asp:RadioButtonList ID="rblICE" runat="server" AutoPostBack="True" 
    ...
    <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          IMID:<asp:TextBox ID="txtIMID" runat="server" Width="95px"></asp:TextBox>       
  </td></tr>
    </asp:Panel>
    </table>
<asp:UpdatePanel ID="updpnl" runat="server"><Triggers><asp:PostBackTrigger ControlID="btnView" /></Triggers><ContentTemplate>
  ...
  <table class="tbl">
        ...
        <tr><td align="center"> <asp:Button ID="btnView" runat="server" Text="View" CssClass="btnsmall" 
...
<CR:CrystalReportViewer ID="IMStockList_Details_Report" 
       ...
       HasCrystalLogo="False" HasToggleGroupTreeButton="false" 
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="IMStockCrt.rpt">
            </Report>
