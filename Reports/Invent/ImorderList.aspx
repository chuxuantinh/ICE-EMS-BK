<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/FO/FORptMaster.master" AutoEventWireup="true" CodeFile="ImorderList.aspx.cs" Inherits="Reports_Invent_ImorderList" %>
...
<div align="center">
<h2>Required IM OrderList Detail</h2>
<table class="tbl">
<tr><td>
...
<CR:CrystalReportViewer ID="IMOrderList_Details_Report" 
       ...
       HasCrystalLogo="False" HasToggleGroupTreeButton="false" 
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="ImOrderListCrt.rpt">
            </Report>
