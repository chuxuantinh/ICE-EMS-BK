    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (this.IsPostBack)
        {
            ...
            if (this.fileUpload.PostedFile != null && this.fileUpload.PostedFile.ContentLength > 0)
            {
                ...
                string path = this.Server.MapPath(@"Result");
                ...
                const string js = "window.parent.onComplete(1,'Result File Uploaded Successfully.','{0}','{1} of {2} Bytes');";
            ...
            {
                //Call parent page know we have processed the uplaod
                const string js = "window.parent.onComplete(4, 'There was a problem with the result file.','','0 of 0 Bytes');";
