<%@ Page Title="" Language="C#" MasterPageFile="~/Exam/ExamMaster.master" AutoEventWireup="true" CodeFile="OldPapers.aspx.cs" Inherits="Exam_OldPapers" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contenttitle" Runat="Server">Old Question Set
</asp:Content>
...
<div class="fromRegisterlbl"><h1 style="float:right; margin-right:50px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblEnrolment" runat="server" ></asp:Label></h1><h1>
    Old Question Set Application</h1></div>
