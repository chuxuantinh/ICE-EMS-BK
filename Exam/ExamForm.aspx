<%@ Page Title="" Language="C#" MasterPageFile="~/Exam/ExamMaster.master" AutoEventWireup="true" CodeFile="ExamForm.aspx.cs" Inherits="Exam_ExamForm" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="dev" %>
<asp:Content ID="Content1" ContentPlaceHolderID="contenttitle" Runat="Server">Examination Form</asp:Content>
...
document.onkeydown = function (e) {
  ...
  <script language="javascript">      function Enterpwd() {
          var pwd = prompt("Enter Password");
          document.getElementById('<%=pass.ClientID%>').innerHTML = pwd.toString();
          if (pwd == "exam")
              return true;
          else return false;
      }</script>
...
<table><tr><td><asp:LinkButton ID="lblHomeRedirect" runat="server" onclick="lblHomeRedirect_Click" Text="Home" CssClass="redirecttab"></asp:LinkButton></td><td>
        <asp:LinkButton ID="lbtnNext1Redirect" runat="server" Text="Examination" CssClass="redirecttab"
            onclick="lbtnNext1Redirect_Click" ></asp:LinkButton><asp:LinkButton ID="lbtnUpdateExamForm" runat="server" Text="Update Exam Form" CssClass="redirecttab" OnClick="lbtnUpdateExamForm_OnClick" ></asp:LinkButton> 
        <asp:LinkButton ID="LinkButton1" runat="server" Text="Fill Improvment Form" 
            CssClass="redirecttab" onclick="LinkButton1_Click" ></asp:LinkButton></td>/tr></table>
            </div>
<div id="rightpanel2">
...
<ContentTemplate>
<div class="fromRegisterlbl"><h1 style="float:right; margin-right:50px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblEnrolment" runat="server" ></asp:Label></h1><h1>Examination Form&nbsp;&nbsp;&nbsp;Exam Schedule:&nbsp;&nbsp;<asp:DropDownList ID="ddlExamSchedule" runat="server" CssClass="txtbox"><asp:ListItem Value="Home" Text="Home" /><asp:ListItem Value="Overseas" Text="Overseas" /></asp:DropDownList></h1>
    </div>
<center><table><tr><td>Exam Session:</td><td><asp:DropDownList ID="ddlExamSeason" runat="server" CssClass="txtbox" AutoPostBack="true" OnSelectedIndexChanged="ddlExamSeason_SelectedIndexChanged" ><asp:ListItem Text="Summer Examination" Value="Sum"></asp:ListItem><asp:ListItem Text="Winter Examination" Value="Win"></asp:ListItem></asp:DropDownList></td><td>Year:&nbsp;&nbsp;&nbsp; <asp:TextBox ID="txtYearSeason" AutoPostBack="true" OnTextChanged="txtYearSeason_TextChanged" runat="server" CssClass="txtbox"></asp:TextBox>&nbsp;&nbsp;<asp:Label ID="lblSessionID" runat="server"></asp:Label> 
     </td></tr></table></center></ul>
<br /><asp:Label ID="lblNameOld" runat="server"></asp:Label><center>Application  No or Membership:&nbsp;&nbsp;<asp:TextBox ID="txticesn" runat="server" Width="100px" AutoPostBack="true" OnTextChanged="txtSerialNo_TextChanged" CssClass="txtbox"></asp:TextBox>
&nbsp;Exam Form No:<asp:Label
        ID="Examformno" runat="server" Text=""></asp:Label><b>
...
<asp:Label ID="lblpart" runat="server" Visible="false"></asp:Label><asp:Label ID="lblHiddendStream" runat="server" Visible="false" ></asp:Label>
...
<asp:GridView ID="GridArchi" runat="server" AutoGenerateColumns="False"
 ...
 <table class="tbl">
<tr><td>
  <asp:TextBox runat="server" id="pass" Visible="False"></asp:TextBox></td>
<td><asp:Button ID="btnselectfour" runat="server" OnClick="btnselectFour_Click" 
        Height="0px" Width="0px" /><asp:TextBox ID="txtRemarks" runat="server" CssClass="txtbox" Height="24px" TextMode="MultiLine" Width="147px"></asp:TextBox></td><td><asp:Button ID="btnSave" runat="server" CssClass="btnsmall" OnClick="btnSaveExamForm_Click" Text="Save ExamForm" />&nbsp;&nbsp;<asp:Button ID="btnHold" runat="server" CssClass="btnsmall" Text="Hold" 
        onclick="btnHold_Click" /> <asp:Button ID="btnSaveForm" runat="server" 
            Text="Save Form" CssClass="btnsmall" onclick="btnSaveForm_Click" OnClientClick="return Enterpwd();"/></td>
