<%@ Page Title="" Language="C#" MasterPageFile="~/Exam/ExamMaster.master" AutoEventWireup="true" CodeFile="AdmitCardNotFound.aspx.cs" Inherits="Exam_AdmitCardNotFound" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contenttitle" Runat="Server">Admit Card Not Found
</asp:Content>
...
<div id="rightpanel2">
<div class="fromRegisterlbl"><h1 style="float:right; margin-right:50px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblEnrolment" runat="server" ></asp:Label></h1><h1>Admit Card</h1></div><br />
<br /><center>Select Examination Session:&nbsp;&nbsp;<asp:DropDownList 
            ...
            onselectedindexchanged="ddlExamSeason_SelectedIndexChanged"  ><asp:ListItem Text="Summer Examination" Value="Sum"></asp:ListItem><asp:ListItem Text="Winter Examination" Value="Win"></asp:ListItem></asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtYearSeason" runat="server" CssClass="txtbox" AutoPostBack="true" Width="100px" OnTextChanged="txtYearSeason_TextChanged"></asp:TextBox></center>
...
<asp:Label ID="lblSeasonHidden" runat="server" Visible="false"></asp:Label>
    ...
    <center>
        ...
        <asp:DropDownList ID="ddlList" runat="server" AutoPostBack="True" 
            ...
            AutoPostBack="true" Width="100px" ontextchanged="txtIMID_TextChanged" ></asp:TextBox>
...
<div class="togalfees" style="width:100%">
  ...
  <asp:ImageButton ID="ImageButton1" runat="server"  Height="30px" Width="30px" AlternateText="Doc" ImageUrl="~/images/doc_icon.png" OnClick="ibtnExportDocAppTableDoc_click" />&nbsp;&nbsp;<asp:ImageButton ID="ImageButton2"  Height="30px" Width="30px"  runat="server" AlternateText="Excel" ImageUrl="~/images/excel_icon.gif" OnClick="ibtnExportExcelAppTableDoc_Click" />&nbsp;&nbsp;<asp:ImageButton ID="ImageButton3"  Height="30px" Width="30px" runat="server" AlternateText="PDF" ImageUrl="~/images/pdf-icon3.gif" OnClick="ibtnExportPDFAppTableDoc_Click" />
    ...
    </div><div style="padding:5px; color:White; font-size:15px;"><asp:RadioButton ID="rbtnGenerated" runat="server" AutoPostBack="True" 
