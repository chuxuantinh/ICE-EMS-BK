<%@ Page Title="" Language="C#" MasterPageFile="~/Exam/ExamMaster.master" AutoEventWireup="true" CodeFile="AdmitCardAppli.aspx.cs" Inherits="Exam_AdmitCardAppli" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contenttitle" Runat="Server">Admit Card Application
</asp:Content>
...
<div id="rightpanel2">
<div class="fromRegisterlbl"><h1 style="float:right; margin-right:50px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblEnrolment" runat="server" ></asp:Label></h1><h1>Admit Card Application</h1></div>
