<%@ Page Title="" Language="C#" MasterPageFile="~/Exam/ExamMaster.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="MarksUpload.aspx.cs" Inherits="Exam_MarksUpload" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contenttitle" Runat="Server">Upload Marks
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:ScriptManager ID="scriptmanager11" runat="server" EnablePageMethods="true"></asp:ScriptManager>
                                ...
                                <tr>
                                    <td>
                                        <div id="dvUploader">
                                            ...
                                            <tr><td>Exam Session:&nbsp;</td><td><asp:DropDownList ID="ddlExamSeason" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlExamSeason_SelectedIndexChanged" CssClass="txtbox" ><asp:ListItem Text="Summer Examination" Value="Sum"></asp:ListItem><asp:ListItem Text="Winter Examination" Value="Win"></asp:ListItem></asp:DropDownList></td><td>Year:</td><td> <asp:TextBox ID="txtYearSeason" AutoPostBack="true" OnTextChanged="txtYearSeason_TextChanged" runat="server" CssClass="txtbox" Width="100px"></asp:TextBox>
    <asp:Label ID="lblExamSeasonHidden" runat="server" Visible="false"/></td></tr>
<tr><td>Course:</td><td><asp:DropDownList ID="ddlCourse" runat="server" 
        ...
        <td>Section/Part:</td><td><asp:DropDownList ID="ddlPart" runat="server" CssClass="txtbox"  Width="80px" >
