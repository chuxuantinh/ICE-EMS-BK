<%@ Page Title="" Language="C#" MasterPageFile="~/Exam/ExamMaster.master" AutoEventWireup="true" CodeFile="MarksStatementAppli.aspx.cs" Inherits="Exam_MarksStatementAppli" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contenttitle" Runat="Server">Final Marksheet Application
</asp:Content>
...
<table><tr><td><asp:LinkButton ID="lblHomeRedirect" runat="server" onclick="lblHomeRedirect_Click" Text="Home" CssClass="redirecttab"></asp:LinkButton></td><td>
        <asp:LinkButton ID="lbtnNext1Redirect" runat="server" CssClass="redirecttab"
            onclick="lbtnNext1Redirect_Click" Text="Examination" ></asp:LinkButton> </td><td><asp:Label ID="lblDefault" runat="server" CssClass="redirecttabhome" Text="Final Marksheet Application"></asp:Label></td></tr></table></div>
<div id="rightpanel2">
<div class="fromRegisterlbl"><h1 style="float:right; margin-right:50px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblEnrolment" runat="server" ></asp:Label></h1><h1>
  Final Marksheet Application</h1></div>
...
<div id="divdatagrid2" style="width: 100%; overflow:scroll; height:450px">
    <asp:GridView ID="GridView" runat="server" AllowPaging="True" BackColor="White" 
        ...
        </Columns><RowStyle HorizontalAlign="Left" />
