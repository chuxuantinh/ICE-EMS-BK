<%@ Page Language="C#" MasterPageFile="~/MasterAccount.master" AutoEventWireup="true" CodeFile="ViewDiaryEntry.aspx.cs" Inherits="FO_ViewDiaryEntry" Title="Untitled Page" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="dev" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">View Diary Details: ICE(I)
</asp:Content>
...
<div id="redirect"><table><tr><td><asp:LinkButton ID="lblHomeRedirect" 
        runat="server" onclick="ibtnHome_Click" Text="Home" CssClass="redirecttab"></asp:LinkButton></td><td>
         </td><td><asp:Label ID="lblViewDiaryEntry" runat="server" Text="View Diary Entry" CssClass="redirecttabhome"></asp:Label></td></tr></table></div>
             <div id="rightpanel2" ><div id="header">
            <asp:UpdatePanel ID="updatepanel" runat="server" ><ContentTemplate>
             <div class="fromRegisterlbl"><h1>View Diary Details:</h1>&nbsp;&nbsp; <br />
                            <center><strong>Select Type:</strong>&nbsp;
                                ...
                                <asp:ListItem Value="Date" Text="Date" />
                                   ...
                                   <asp:ListItem Value="Student" Text="Student"></asp:ListItem>
                                    <asp:ListItem Value="DiaryNo" Text="Diary No" /><asp:ListItem Value="Reference" Text="Reference No."></asp:ListItem>
                                    <asp:ListItem Value="Consignmentno" Text="Consignment No"></asp:ListItem>
                                </asp:DropDownList></div>
                           <br />
                         <center>  <div id="dates" runat="server" >
...
<dev:CalendarExtender Format="dd/MM/yyyy" ID="devdage" PopupButtonID="cal" PopupPosition="BottomRight" runat="server" TargetControlID="dropp"></dev:CalendarExtender><img src="../images/cal.png" id="cal" runat="server"  alt="Cal" /> &nbsp;TO
...
<dev:CalendarExtender Format="dd/MM/yyyy" ID="CalendarExtender1" PopupButtonID="cald" PopupPosition="BottomRight" runat="server" TargetControlID="drop2"></dev:CalendarExtender><img src="../images/cal.png" id="cald" runat="server"  alt="Cald" />
                                &nbsp;&nbsp;&nbsp;Type:&nbsp;<asp:DropDownList ID="ddlTypes" runat="server" CssClass="txtbox">
                             <asp:ListItem Value="All" Text="All" />   <asp:ListItem Value="IM" Text="IM" /><asp:ListItem Value="Student" Text="Student" />
                                <asp:ListItem Value="Other" Text="Other" />
                                </asp:DropDownList>     </div>&nbsp;&nbsp;<asp:Label ID="lblHiddenSeason" runat="server" Visible="false"></asp:Label>
