<%@ Page Title="" Language="C#" MasterPageFile="~/Acc/Account.master" AutoEventWireup="true" CodeFile="CancelAcademicForm3.aspx.cs" Inherits="Acc_CancelAcademicForm3" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="dev" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">Cancel Academic Form-3
</asp:Content>
...
<td><asp:Label ID="lblAount" runat="server" Text="Cancel Academic Form-3" CssClass="redirecttabhome"></asp:Label></td></tr>
</table></div>
<div id="rightpanel2">
...
<div class="fromRegisterlbl"><h1 style="float:right; margin-right:50px;">&nbsp;&nbsp;Fee Master:&nbsp;<asp:DropDownList 
        ID="ddlFeeMaster" runat="server" CssClass="txtbox" Width="85px" Height="16px"><asp:ListItem Value="Home" Text="Home" /><asp:ListItem Value="Overseas" Text="Overseas" /></asp:DropDownList> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblEnrolment" runat="server" ></asp:Label></h1><h1>Cancel Academic Form-3:</h1></div>
<center>Apps Type:&nbsp;<asp:DropDownList ID="ddlAppType" runat="server" 
        CssClass="txtbox" DataSourceID="SqlDataSource1" DataTextField="FeeName" 
        DataValueField="FeeName" >
    </asp:DropDownList>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:icedbConnectionString %>" 
        SelectCommand="SELECT DISTINCT [FeeName] FROM [FeeList] WHERE (([Status] = @Status) AND ([Type] = @Type))">
        <SelectParameters>
            <asp:Parameter DefaultValue="YES" Name="Status" Type="String" />
            <asp:ControlParameter ControlID="ddlFeeMaster" DefaultValue="Home" Name="Type" PropertyName="SelectedValue" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
&nbsp;&nbsp;
