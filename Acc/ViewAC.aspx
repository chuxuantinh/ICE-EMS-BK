<%@ Page Title="" Language="C#" MasterPageFile="~/Acc/Account.master" AutoEventWireup="true" CodeFile="ViewAC.aspx.cs" Inherits="Acc_ViewAC" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="dev" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">View Account Details
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="head" Runat="Server"> <link rel="stylesheet" href="../style.css" type="text/css" charset="utf-8" />	
...
<td><asp:Label ID="lblViewAc" runat="server" Text="View Account Details" CssClass="redirecttabhome"></asp:Label></td></tr>
</table></div>
    <div id="rightpanel2">
    <div class="fromRegisterlbl"><h1>View Account Details </h1></div><br />
...
<asp:Panel ID="pnlDiary" runat="server" ><center>Insert No: &nbsp;&nbsp;&nbsp;<asp:TextBox 
        ID="txtDiary" runat="server" Width="200px" CssClass="txtbox" 
        ontextchanged="txtDiary_TextChanged"></asp:TextBox></center></asp:Panel>
...
<div id="divdatagrid2" style="width: 100%; overflow:scroll; height:450px">
    <asp:GridView ID="GridAC" runat="server" AllowPaging="True" BackColor="White" 
        ...
        onrowdatabound="GridAC_RowDataBound" 
        onpageindexchanging="GridAC_PageIndexChanging">
