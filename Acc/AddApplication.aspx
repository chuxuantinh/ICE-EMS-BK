<%@ Page Title="" Language="C#" MasterPageFile="~/Acc/Account.master" AutoEventWireup="true" CodeFile="AddApplication.aspx.cs" Inherits="Acc_AddApplication" %>
...
<asp:Label ID="lblFullCourse" runat="server" ></asp:Label></div>
    <asp:Label ID="lblAdmissionSerialNo" runat="server" Font-Bold="true"></asp:Label>
<asp:Label ID="lblExamSerialNo" runat="server" Font-Bold="true"></asp:Label>
...
<asp:ListItem Value="ReAdmission" Text="Re-Admission" />
</asp:DropDownList><br />
    <asp:CheckBox ID="chkExam" Text="Exam" runat="server" oncheckedchanged="chkExam_CheckedChanged" AutoPostBack="True" />&nbsp;&nbsp;&nbsp;&nbsp;
...
<!-- Invisible Controls -->
<asp:Label ID="lblFeeLevel" runat="server" Visible="false" ></asp:Label>
<asp:Label ID="lblOldFeeLevel" runat="server" Visible="false"></asp:Label>
<asp:Label ID="lblCourseLevel" Text="081" runat="server"  Visible="false"></asp:Label>
<asp:Label ID="lblCompositeDuration" runat="server" Visible="false"></asp:Label>
<asp:Label ID="lblExamStatus" runat="server" Visible="false"></asp:Label>
<asp:Label ID="lblenrolStatus" runat="server"  Visible="false"></asp:Label>
<asp:Label ID="lblUnderAge" runat="server"  Visible="false"></asp:Label>
   <asp:Label ID="lblCourse" runat="server" Visible="false"></asp:Label>
   <asp:Label ID="lblpart" runat="server" Visible="false"></asp:Label>
   <asp:Label ID="lblHiddendStream" runat="server" Visible="false" ></asp:Label>
   <asp:Label ID="lblFormType" runat="server" Visible="false"></asp:Label>
   <asp:Label ID="lblPartIISID" runat="server" Visible="false"></asp:Label>
   <asp:Label ID="lblASF" runat="server" Visible="false"></asp:Label>

  <!-- Invisible controls End-->

    <asp:Panel ID="PanelExamFee" runat="server" >
    <center><font style="color:Maroon; font-size:18px; font-family:Times New Roman; padding:0px;">Examination Fees Module</font><br />
   <asp:RadioButtonList ID="rbtnImppromote" runat="server" CellSpacing="20" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rbtnImprovement_CheckChanged" Visible="false" >
   <asp:ListItem Value="Improvement" Text="Improvement" />
   <asp:ListItem Value="Promote" Text="Promote" /></asp:RadioButtonList>
    </center>
    <table width="100%">
    <tr><td>Examination Fee:&nbsp;<asp:Label ID="lblExamFee" runat="server" 
            Font-Bold="True" ForeColor="Maroon" ></asp:Label>&nbsp;Rs.</td><td>Late Fee Apply:&nbsp;&nbsp;<asp:Label 
                ID="lblLFee" runat="server" Font-Bold="False" ForeColor="Maroon" ></asp:Label>&nbsp;Rs.</td></tr>
                <tr><td>Exemption Fee:&nbsp;<asp:Label 
    ...
    <center><font style="color:Maroon; font-size:18px; font-family:Times New Roman; padding:0px;">Admission Fees Module</font></center><br />
<br />
    <table width="80%" class="tbl"><tr><td>Admission Fees:&nbsp;<asp:Label ID="lblAdmissionFees" runat="server" Font-Bold="true" ForeColor="Maroon"></asp:Label> &nbsp;&nbsp;Rs.</td>
    <td><asp:Label ID="lblDupFormFee" runat="server" Font-Bold="true" ForeColor="Maroon"></asp:Label>&nbsp;Rs.&nbsp;<asp:CheckBox ID="chkDupForsm" runat="server" Text="Duplicate Form" /></td></tr>
    </table>
    <fieldset>
    <legend>&nbsp;Membership Fee Master</legend>
    <table class="tbl" width="80%"><tr><td>Part I/Section A&nbsp;&nbsp;<asp:Label 
            ID="lblMFEE1" runat="server" Font-Bold="True" ForeColor="Maroon" ></asp:Label> &nbsp;Rs.</td><td>Part II/Section B&nbsp;&nbsp;<asp:Label ID="lblMFEE2" 
            runat="server" Font-Bold="True" ForeColor="Maroon" ></asp:Label> &nbsp;Rs.</td></tr></table>
    </fieldset>
    <hr />
    </asp:Panel>
