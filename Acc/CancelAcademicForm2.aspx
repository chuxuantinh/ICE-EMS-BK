<%@ Page Title="" Language="C#" MasterPageFile="~/Acc/Account.master" AutoEventWireup="true" CodeFile="CancelAcademicForm2.aspx.cs" Inherits="Acc_CancelAcademicForm2" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="dev" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">Cancel Academic Form-2
</asp:Content>
...
<td><asp:Label ID="lblAount" runat="server" Text="Cancel Academic Form-2" CssClass="redirecttabhome"></asp:Label></td></tr>
</table></div>
<div id="rightpanel2">
<asp:UpdatePanel ID="UpdatePanelIMInfo" runat="server" ><ContentTemplate>
<div class="fromRegisterlbl"><h1 style="float:right; margin-right:50px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblEnrolment" runat="server" ></asp:Label></h1><h1>Cancel Academic Form-2:</h1></div>
...
<asp:ListItem Value="ProvisionalCertificate" Text="Provisional Certificate" ></asp:ListItem>
    ...
    <asp:ListItem Value="MCADRegistration" Text="MCADRegistration" />
    <asp:ListItem Value="MCADLateFee" Text="MCADLateFee" />
    </asp:DropDownList>
&nbsp;&nbsp;
