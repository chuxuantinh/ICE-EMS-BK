<%@ Page Title="" Language="C#" MasterPageFile="~/Acc/Account.master" AutoEventWireup="true" CodeFile="CancelReChecking.aspx.cs" Inherits="Acc_CancelReChecking" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="dev" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">Cancel ReChecking Form
</asp:Content>
...
<td><asp:Label ID="lblAount" runat="server" Text="Cancel ReChecking Forms" CssClass="redirecttabhome"></asp:Label></td></tr>
</table></div>
<div id="rightpanel2">
