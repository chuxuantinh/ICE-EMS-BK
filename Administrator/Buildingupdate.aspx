<%@ Page Language="C#" MasterPageFile="~/Administrator/IMMaster.master" AutoEventWireup="true" CodeFile="Buildingupdate.aspx.cs" Inherits="Administrator_Buildingupdate" Title="Untitled Page" %>
...
<div class="fromRegisterlbl"><h1> Building Facilities Available</h1></div>
      ...
      <tr style="text-align:center;"><td style="height: 23px; width: 76px;">Particulars</td><td style="height: 23px; width: 165px;">No. of Rooms
        ...
        <asp:Button ID="btnSave" runat="server" OnClick="Button1_Click" ValidationGroup="abuild" Text="Update" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnCalcel" runat="server" Text="Cancel"  OnClick="btnCencel_Click"/></center><br /><br />
 </div>
 </div>
</asp:Content>
