<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/Fees/FeeMaster.master" AutoEventWireup="true" CodeFile="TechnicianFeesShow.aspx.cs" Inherits="Administrator_Fees_TechnicianFeesShow" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">Technician Fees Master
</asp:Content>
...
<div id="Div4" style="display: none;">
 ...
 Part I:<asp:Label ID="lblSecA" runat="server" CssClass="feelabel"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;(Per Attempt)<br />
 
 Part II:<asp:Label ID="lblSecB" runat="server" CssClass="feelabel"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;(Per Attempt)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ITI Fees(Rs.):&nbsp;<asp:Label ID="lblITIFees" runat="server" Font-Bold="true"></asp:Label><br />
 ...
 <div class="fromRegisterlbl"><h1>Sets of Old Question Papers.</h1></div>
  <div class="feestable">
    ...
    Part II:<asp:Label ID="lblOldSecA" runat="server" CssClass="feelabel"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;(Per Set)<br />
 
 Part II:<asp:Label ID="lblOldSecB" runat="server" CssClass="feelabel"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;(Per Set)<br />
   <br /></div>
