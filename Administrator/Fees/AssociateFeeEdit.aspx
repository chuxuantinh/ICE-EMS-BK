<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/Fees/FeeMaster.master" AutoEventWireup="true" CodeFile="AssociateFeeEdit.aspx.cs" Inherits="Administrator_Fees_AssociateFeeEdit" %>
...
<center><asp:Label ID="lblExamScheduleInfo" runat="server" ForeColor="Green"></asp:Label><asp:Label ID="lblMessage" runat="server" ForeColor="Red"></asp:Label>
<br />
<br /><asp:Button ID="btnSaveExamSchedule" ValidationGroup="A2" runat="server" Text="Save" onclick="btnSaveExamSchedule_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnClear2" runat="server" Text="Clear" onclick="btnClear2_Click" /></center>
</div> 
</ContentTemplate></asp:UpdatePanel>
</div>
</div>
...
<center> <asp:Label ID="lblExemptionfeeInfo" runat="server" ForeColor="Green"></asp:Label></center>
<br /><center><asp:Button ID="btnSaveExemption" runat="server" Text="Save" ValidationGroup="A3" onclick="btnSaveExemption_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnClear3" runat="server" Text="Clear" onclick="btnClear3_Click" /></center>
</ContentTemplate></asp:UpdatePanel>
</div><br /></div>
<script>
...
<div class="">
<table width="95%"><tr>
<td align="right">Provisional Certificate Fee:</td>
<td><asp:TextBox ID="lblProCertificate" runat="server" CssClass="feelabel"></asp:TextBox><asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator13" controltovalidate="lblProCertificate" Display="Dynamic" ValidationGroup="A4" errormessage="Please Insert Provisional Certificate Fee" >*</asp:RequiredFieldValidator>
...
<td align="right">Certification Fee:</td>
<td><asp:TextBox ID="lblCertificationFee" runat="server" CssClass="feelabel"></asp:TextBox><asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator14" controltovalidate="lblCertificationFee" Display="Dynamic" ValidationGroup="A4" errormessage="Please Insert Certification Fee" >*</asp:RequiredFieldValidator>
...
<center><asp:Label ID="lblProjectInfo" runat="server" ForeColor="Green"></asp:Label></center>
<br /><center><asp:Button ID="btnProjects" ValidationGroup="A4" runat="server" Text="Save" onclick="btnProjects_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnClear4" runat="server" Text="Clear" onclick="btnClear4_Click" />
</center>
</ContentTemplate></asp:UpdatePanel>
</div><br /></div>
<script>
...
Section A:<asp:TextBox ID="lblSecA" runat="server" CssClass="feelabel"></asp:TextBox>
...
Section B:<asp:TextBox ID="lblSecB" runat="server" CssClass="feelabel"></asp:TextBox>
...
Section B:<asp:TextBox ID="lblOldSecB" runat="server" CssClass="feelabel"></asp:TextBox>
...
<center><asp:Label ID="lblSecInfo" runat="server" ForeColor="Green"></asp:Label></center><br />
<center><asp:Button ID="btnSaveExamFee" runat="server" Text="Save" ValidationGroup="A5" onclick="btnSaveExamFee_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnClear5" runat="server" Text="Clear" onclick="btnClear5_Click" /></center>
</ContentTemplate></asp:UpdatePanel>
</div><br /></div>
</asp:Content>
