...
public partial class Administrator_Fees_TechnicianFeesShow : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from FeeMaster where FeeType='Tech' and FeeLevel='" + Request.QueryString["lvl"] + "' and type='" + Request.QueryString["type"] + "'", con);
