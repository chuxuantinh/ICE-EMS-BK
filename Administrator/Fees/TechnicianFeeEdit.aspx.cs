...
public partial class Administrator_Fees_TechnicianFeeEdit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            try
            {
                ...
                con.Open();
                SqlDataReader rd;
                SqlCommand cmd = new SqlCommand("select * from FeeMaster where FeeType='Tech' and type='" + Request.QueryString["type"] + "'", con);
                ...
                if (i == 0)
                {
                    SqlCommand cmdins = new SqlCommand("insert into FeeMaster(FeeType) Values('Tech')", con);
                ...
                if (i == 1)
                {
                    if (!IsPostBack)
                    {
                        ...
                        SqlCommand cmdrd = new SqlCommand("select * from FeeMaster where FeeType='Tech'  and FeeLevel='" + Request.QueryString["lvl"] + "' and type='" + Request.QueryString["type"] + "'", con);
    ...
    protected void btnSaveMembership_Click(object sender, EventArgs e)
    {
        try
        {
            con.Close();
            con.Open();
            SqlCommand cmd = new SqlCommand("update FeeMaster set FeeType=@FeeType,MemFee1=@MemFee1,ComFee1=@ComFee1,MemFee2=@MemFee2,ComFee2=@ComFee2,CompositeDuration=@CompositeDuration where FeeType='Tech' and FeeLevel='" + Request.QueryString["lvl"] + "' and type='" + Request.QueryString["type"] + "'", con);
    ...
    protected void btnSaveExamSchedule_Click(object sender, EventArgs e)
    {
        ...
        {
            lblExamScheduleInfo.Text = "Please Fill Details.!";
        }
        else
        {
            try
            {
                ...
                con.Close();
                con.Open();
                SqlCommand cmd = new SqlCommand("update FeeMaster set SumExamWOL=@SumExamWOL,WinExamWOL=@WinExamWOL,SumExamWL1=@SumExamWL1,SumExamWL2=@SumExamWL2,SumExamWL3=@SumExamWL3,WinExamWL1=@WinExamWL1,WinExamWL2=@WinExamWL2,WinExamWL3=@WinExamWL3,ExamLF1=@ExamLF1,ExamLF2=@ExamLF2,ExamLF3=@ExamLF3,SumExamSchedule=@SumExamSchedule,WinExamSchedule=@WinExamSchedule where FeeType='Tech' and FeeLevel='" + Request.QueryString["lvl"] + "' and type='" + Request.QueryString["type"] + "'", con);
    ...
    protected void btnSaveExemption_Click(object sender, EventArgs e)
    {
        ...
        {
            con.Close();  con.Open();
            SqlCommand cmd = new SqlCommand("update FeeMaster set ExemptionFee=@ExemptionFee,ASubscription=@ASubscription,ExamCChange=@ExamCChange,ReChacking=@ReChacking where FeeType='Tech' and FeeLevel='" + Request.QueryString["lvl"] + "' and type='" + Request.QueryString["type"] + "'", con);
    ...
    protected void btnSaveExamFee_Click(object sender, EventArgs e)
    {
        ...
        {
            con.Close();  con.Open();
            SqlCommand cmd = new SqlCommand("update FeeMaster set ESecA=@ESecA,ESecB=@ESecB,OSecA=@OSecA,OSecB=@OSecB,Postal=@Postal,ITIFees=@ITIFees where FeeType='Tech' and FeeLevel='" + Request.QueryString["lvl"] + "' and type='" + Request.QueryString["type"] + "'", con);
    ...
    protected void btnClear2_Click(object sender, EventArgs e)
    {
        ...
        txtSumWL3.Text = ""; txtWinWL3.Text = ""; lblExamScheduleInfo.Text = "";
    }
