<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/Administrator.master" AutoEventWireup="true" CodeFile="Certificate.aspx.cs" Inherits="Administrator_Certificate" %>
...
<asp:Panel ID="panlSession" runat="server" ><center><table width="90%" class="tbl"><tr>
    ...
    <asp:DropDownList ID="ddlSelect" runat="server" AutoPostBack="True" 
        ...
        &nbsp;&nbsp; 
    </td></tr><tr><td class="style1"></td><td align="left"><asp:Button ID="btnView" runat="server" CssClass="btnsmall" Text="Approve" 
        OnClick="btnVeiw_OnClick"    /></td></tr></table>
    </center></asp:Panel>
<script>
