<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/Fees/FeeMaster.master" AutoEventWireup="true" CodeFile="ArchiSyllabus.aspx.cs" Inherits="Administrator_Course_ArchiSyllabus" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="dev" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">Architectural Engineering Subject
</asp:Content>
...
<table><tr><td>Select Subject:</td><td>
    <asp:DropDownList ID="ddlSubject" runat="server" AutoPostBack="True" 
        DataSourceID="SqlDataSource1" DataTextField="SubName" DataValueField="SubName" 
        onselectedindexchanged="ddlSubject_SelectedIndexChanged" Width="260px">
    </asp:DropDownList>
    </td></tr></table>
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:icedbConnectionString %>" SelectCommand="SELECT [SubName] FROM [ArchiSubMaster] WHERE (([Section] = @Section) AND ([CourseID] = @CourseID)) ORDER BY [SubID]">
<SelectParameters>
<asp:ControlParameter ControlID="lblSecType" Name="Section" PropertyName="Text" Type="String" />
<asp:QueryStringParameter Name="CourseID" QueryStringField="id" Type="String" />
</SelectParameters>
</asp:SqlDataSource>
<table><tr align="right"><td>&nbsp;</td><td align="left">
    ...
    <tr align="right">
        <td>
            Subject ID:</td>
        <td align="left">
            <asp:TextBox ID="txtSubID" runat="server" AutoPostBack="True" 
                ontextchanged="txtSubID_TextChanged" Width="260px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="rexID" runat="server" 
                ControlToValidate="txtSubID" Display="Dynamic" 
                ErrorMessage="Please Insert Subject ID." ForeColor="Red" 
                ValidationGroup="Architecture">*</asp:RequiredFieldValidator>
        </td>
    </tr>
<tr  align="right"><td>Subject Name:</td><td align="left">
    <asp:TextBox ID="txtSubName" Width="260px" runat="server" ></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtSubName" Display="Dynamic" ValidationGroup="Architecture" ForeColor="Red" ErrorMessage="Please Insert Subject Name." >*</asp:RequiredFieldValidator></td></tr>
...
<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:icedbConnectionString %>" SelectCommand="SELECT [SubID], [SubName], [MaxMark], [MinMark], [First], [Date] FROM [ArchiSubMaster] WHERE (([Section] = @Section)  AND ([CourseID] = @CourseID)) ORDER BY [SubID]">
<SelectParameters>
...
<asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:icedbConnectionString %>" SelectCommand="SELECT [SubID], [SubName], [MaxMark], [MinMark], [Date], [First], [SubjectType] FROM [ArchiSubMaster] WHERE (([Section] = @Section) AND ([CourseID]=@CourseID)) ORDER BY [SubID]">
<SelectParameters>
...
<asp:GridView ID="GridView4" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999"  PageSize="25" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource5" ForeColor="Black" GridLines="Vertical" Width="100%">
<Columns>
<asp:BoundField DataField="SubID" HeaderText="SubID" SortExpression="Subject Code" />
<asp:BoundField DataField="SubName" HeaderText="Subject Name" SortExpression="SubName" />
<asp:BoundField DataField="MaxMark" HeaderText="Total" SortExpression="MaxMark" />
...
<asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:icedbConnectionString %>" SelectCommand="SELECT [SubID], [SubName], [MaxMark], [MinMark], [First], [Date] FROM [ArchiSubMaster] WHERE (([Section] = @Section) AND ([CourseID]=@CourseID)) ORDER BY [SubID]">
<SelectParameters>
<asp:Parameter DefaultValue="SectionA" Name="Section" Type="String" />
<asp:QueryStringParameter QueryStringField="id" Name="CourseID" Type="String" />
</SelectParameters>
</asp:SqlDataSource>
<br /></div>
</asp:Panel><br />
...
<asp:GridView ID="GridView3" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" PageSize="25" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource4" ForeColor="Black" GridLines="Vertical" Width="100%">
<Columns>
<asp:BoundField DataField="SubID" HeaderText="SubID" SortExpression="Subject Code" />
<asp:BoundField DataField="SubName" HeaderText="Subject Name" SortExpression="SubName" />
<asp:BoundField DataField="MaxMark" HeaderText="Total" SortExpression="MaxMark" />
...
<asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:icedbConnectionString %>" SelectCommand="SELECT [SubID], [SubName], [MaxMark], [MinMark], [First], [Date], [SubjectType] FROM [ArchiSubMaster] WHERE (([Section] = @Section) AND ([CourseID]=@CourseID)) ORDER BY [SubID]">
<SelectParameters>
<asp:Parameter DefaultValue="SectionB" Name="Section" Type="String" />
<asp:QueryStringParameter Name="CourseID" Type="String" QueryStringField="id" />
</SelectParameters>
</asp:SqlDataSource>
<br /></div></asp:Panel>
