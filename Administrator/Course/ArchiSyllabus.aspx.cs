...
public partial class Administrator_Course_ArchiSyllabus : System.Web.UI.Page
{
    ...
    {
        PnlSubjectEdit.Visible = true;
        lblSubType.Text = "Part II";
        chkfn();
        lblSecType.Text = "PartII";
        chkSubjectType.Visible = true;
        getSubNo();
    }
    ...
    {
        PnlSubjectEdit.Visible = true;
        lblSubType.Text = "Section A";
        chkfn();
        lblSecType.Text = "SectionA";
        getSubNo();
        chkSubjectType.Visible = false;
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into ArchiSubMaster (SubID,SubName,MaxMark,MinMark,First,Lvl,Section,SubjectType,CourseID) values(@SubID,@SubName,@MaxMark,@MinMark,@First,@Lvl,@Section,@SubjectType,@CourseID)", con);
    ...
    protected void ddlSubject_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            con.Close();
            con.Open();
            SqlCommand cmd = new SqlCommand("select * from ArchiSubMaster where SubName='" + ddlSubject.SelectedValue.ToString() + "' and CourseID='"+Request.QueryString["id"].ToString()+"'", con);
            SqlDataReader rd;
            ...
            rd.Close();
            rd.Dispose();
            btnUpdate.Visible = true; btnDelete.Visible = true; btnSave.Visible = false;
        }
        catch (SqlException ex)
        {
            lblSaveException.Text = ex.ToString();
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            con.Close();
            con.Open();
            SqlCommand cmd = new SqlCommand("update ArchiSubMaster set SubID=@SubID,SubName=@SubName,MaxMark=@MaxMark,MinMark=@MinMark,First=@First,Lvl=@Lvl,Section=@Section,Date=@Date,SubjectType=@SubjectType where SubName='" + ddlSubject.SelectedValue.ToString() + "'", con);
            cmd.Parameters.AddWithValue("@SubID", txtSubID.Text.ToString());
            cmd.Parameters.AddWithValue("@SubName", txtSubName.Text.ToString());
            cmd.Parameters.AddWithValue("@MaxMark", txtMaxMark.Text.ToString());
            cmd.Parameters.AddWithValue("@MinMark", txtMinMark.Text.ToString());
    ...
    public void getSubNo()
    {
        try
        {
            ...
            con.Close();
             con.Open();
            SqlCommand cmd1 = new SqlCommand("select * from ArchiSubMaster where Section='" + lblSecType.Text.ToString() + "' and CourseID='"+Request.QueryString["id"].ToString()+"'", con);
            SqlDataReader rd;
            ...
            if (i == 0)
            {
                ...
                SqlCommand cmd = new SqlCommand("insert into ArchiSubMaster (Lvl,Section,CourseID) values(@Lvl,@Section,@CourseID)", con);
                int lvl = 0;
            ...
            SqlCommand cmd3 = new SqlCommand("select max(Lvl) from ArchiSubMaster where Section='" + lblSecType.Text.ToString() + "' and CourseID='"+Request.QueryString["id"].ToString()+"'", con);
    ...
    protected void txtSubID_TextChanged(object sender, EventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("select SubID from ArchiSubMaster where SubID='"+txtSubID.Text.ToString()+"' and CourseID='"+Request.QueryString["id"].ToString()+"'", con);
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        con.Close();
        con.Open();
        SqlCommand cmd = new SqlCommand("delete ArchiSubMaster where SubName='" + ddlSubject.SelectedValue.ToString() + "' and CourseID='" + Request.QueryString["id"].ToString() + "'", con);
        cmd.ExecuteNonQuery();
